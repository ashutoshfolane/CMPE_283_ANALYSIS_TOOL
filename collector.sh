...
echo {"\"vmname\"": "\"T03_VM_RICHIL\"", "\"time\"":$(date), "\"cpu_usage_perc\"":$CPU_USAGE_PERCENT, "\"mem_used_kb\"":$MEM_USED_KB, "\"io_read_byte\"":$IO_READ_BYTE, "\"io_write_byte\"":$IO_WRITE_BYTE, "\"nw_tx_kbps\"":$NW_TX_KBPS} >> metric.log
